...
+ m.impl("add.out", CppFunction::makeFallthrough()); // ttnn::add
...
+ m.impl("sub.out", CppFunction::makeFallthrough()); // ttnn::subtract
...
TORCH_LIBRARY_IMPL(aten, PrivateUse1, m) {
    ...
    // =========================
    // Other aten ops (commented fallthrough references, sorted)
    // =========================
    //  m.impl("_cdist_forward", CppFunction::makeFallthrough());
    //  m.impl("_fused_dropout", CppFunction::makeFallthrough());
    //  m.impl("_local_scalar_dense", CppFunction::makeFallthrough());
